...
class BinarySearchTree:
	...
	def reverse_inorder_traversal_k(self,root,k):
		if root==None:
			return

		self.reverse_inorder_traversal_k(root.right,k)
		...
		self.reverse_inorder_traversal_k(root.left,k)
...
def main():
	...
	tree.reverse_inorder_traversal_k(rootnode,1) 
